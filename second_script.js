...
function redirectToActualIndex() {
...
function calcularFracionamento() {
    ...
    let metragemRealPrimeiraBobina = metragemFracionamento;
    ...
    if (produtoEscolhido == "CAT5e") {
        ...
        const metragemMaqBobina1 = metragemFinal1 * metragemMaquina / metragemEtiqueta;
        ...
        resultadoHTML = `<h3>Dados para Fracionamento:</h3>
        <table class="modern-table">
            <tr>
                <td>Primeira bobina Fracionada:</td>
                <td>${metragemFinal1} m</td>
            </tr>
            <tr>
                <td>Metragem da primeira bobina na máquina:</td>
                <td>${metragemMaqBobina1.toFixed(0)} m</td>
            </tr>
            <tr>
                <td>Segunda bobina Fracionada:</td>
                <td>${metragemFinal2} m</td>
            </tr>
            <tr>
                <td>Metragem da segunda bobina na máquina:</td>
                <td>${metragemMaqBobina2.toFixed(0)} m</td>
            </tr>
        </table>
